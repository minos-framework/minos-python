...
class SagaManager(MinosSetup):
    ...
    @inject
    def __init__(
        self, storage: SagaExecutionStorage, broker_pool: BrokerPool = Provide["broker_pool"], *args, **kwargs,
    ):
    ...
    @staticmethod
    async def _get_response(broker: Broker, execution: SagaExecution, **kwargs) -> SagaResponse:
