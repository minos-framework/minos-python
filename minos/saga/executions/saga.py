...
class SagaExecution:
    ...
    async def _execute_commit(self, *args, **kwargs) -> None:
        try:
            await TransactionCommitter(self.executed_steps, execution_uuid=self.uuid, *args, **kwargs).commit()
    ...
    async def rollback(self, *args, **kwargs) -> None:
        ...
        await TransactionCommitter(self.executed_steps, execution_uuid=self.uuid, *args, **kwargs).reject()
