...
class TestTransaction(MinosTestCase):
    ...
    async def test_async_context_manager(self):
        with patch("minos.common.TransactionEntry.save") as save_mock, patch(
            "minos.common.TransactionEntry.commit"
        ) as commit_mock:
    ...
    async def test_async_context_manager_without_autocommit(self):
        with patch("minos.common.TransactionEntry.commit") as commit_mock:
