...
class TestMinosSnapshot(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_transaction_null(self):
        ...
        self.assertEqual(1, self.get_mock.call_count)
        self.assertEqual((NULL_UUID,), self.get_mock.call_args.kwargs["transaction_uuids"])
    ...
    async def test_get_transaction_context(self):
        ...
        self.assertEqual(1, self.get_mock.call_count)
        self.assertEqual(await transaction.uuids, self.get_mock.call_args.kwargs["transaction_uuids"])
    ...
    async def test_find_transaction_null(self):
        ...
        self.assertEqual(1, self.find_mock.call_count)
        self.assertEqual((NULL_UUID,), self.find_mock.call_args.kwargs["transaction_uuids"])
    ...
    async def test_find_transaction_context(self):
        ...
        self.assertEqual(1, self.find_mock.call_count)
        self.assertEqual(await transaction.uuids, self.find_mock.call_args.kwargs["transaction_uuids"])
