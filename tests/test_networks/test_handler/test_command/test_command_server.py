...
class TestCommandServer(PostgresAsyncTestCase):
    ...
    def test_from_config(self):
        dispatcher = CommandHandlerServer.from_config(config=self.config)
        self.assertIsInstance(dispatcher, CommandHandlerServer)

    def test_from_config_raises(self):
        with self.assertRaises(MinosConfigException):
            CommandHandlerServer.from_config()
    ...
    async def test_queue_add(self):
        ...
        event_server = CommandHandlerServer.from_config(config=self.config)
