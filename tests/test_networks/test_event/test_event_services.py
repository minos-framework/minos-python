...
from minos.networks import MinosEventServerService, MinosEventPeriodicService
from minos.common.testing import PostgresAsyncTestCase
from tests.utils import BASE_PATH


class TestMinosEventServer(PostgresAsyncTestCase):
...
class TestMinosQueueService(PostgresAsyncTestCase):
    ...
    async def test_callback(self):
        ...
        mock = MagicMock(side_effect=service.dispatcher.event_queue_checker)
        service.dispatcher.event_queue_checker = mock
