...
class TestFieldDiffContainer(MinosTestCase):
    async def asyncSetUp(self) -> None:
        ...
        self.car_one = Car(
            3, "blue", id=1, version=1, _repository=self.event_repository, _snapshot=self.snapshot_repository
        )
        self.car_two = Car(
            5, "red", id=1, version=2, _repository=self.event_repository, _snapshot=self.snapshot_repository
        )
        self.car_three = Car(
            5, "yellow", id=1, version=3, _repository=self.event_repository, _snapshot=self.snapshot_repository
        )
        self.car_four = Car(
            3, "blue", id=2, version=1, _repository=self.event_repository, _snapshot=self.snapshot_repository
        )
