...
class TestFieldDiffContainer(MinosTestCase):
    async def asyncSetUp(self) -> None:
        ...
        self.car_one = Car(3, "blue", id=1, version=1, _repository=self.event_repository, _snapshot=self.snapshot)
        self.car_two = Car(5, "red", id=1, version=2, _repository=self.event_repository, _snapshot=self.snapshot)
        self.car_three = Car(5, "yellow", id=1, version=3, _repository=self.event_repository, _snapshot=self.snapshot)
        self.car_four = Car(3, "blue", id=2, version=1, _repository=self.event_repository, _snapshot=self.snapshot)
                ...
                "fields": [
                    {
                        ...
                        "type": {
                            ...
                            "name": "FieldDiff",
                            "namespace": "minos.aggregate.model.diff.hola",
                            "type": "record",
                        },
                    },
                    {
                        ...
                        "type": {
                            ...
                            "name": "FieldDiff",
                            "namespace": "minos.aggregate.model.diff.adios",
                            "type": "record",
                        },
                    },
                ],
                "name": "FieldDiffContainer",
                "namespace": "minos.aggregate.model.diff.uno",
                "type": "record",
            }
        ]
        with patch("minos.aggregate.FieldDiffContainer.generate_random_str", side_effect=["hello", "goodbye"]):
