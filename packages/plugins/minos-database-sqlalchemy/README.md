...
[![PyPI Latest Release](https://img.shields.io/pypi/v/minos-database-sqlalchemy.svg)](https://pypi.org/project/minos-database-sqlalchemy/)
...
```shell
pip install minos-database-sqlalchemy
```
