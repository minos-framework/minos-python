...
class TestFieldDiffContainer(MinosTestCase):
    async def asyncSetUp(self) -> None:
        ...
        self.car_two = Car(5, "red", id=1, version=2)
        self.car_three = Car(5, "yellow", id=1, version=3)
        self.car_four = Car(3, "blue", id=2, version=1)
                ...
                "fields": [
                    {
                        ...
                        "type": {
                            ...
                            "name": "FieldDiff",
                            "namespace": "minos.aggregate.models.events.fields.hola",
                            "type": "record",
                        },
                    },
                    {
                        ...
                        "type": {
                            ...
                            "name": "FieldDiff",
                            "namespace": "minos.aggregate.models.events.fields.adios",
                            "type": "record",
                        },
                    },
                ],
                "name": "FieldDiffContainer",
                "namespace": "minos.aggregate.models.events.fields.uno",
                "type": "record",
            }
        ]
